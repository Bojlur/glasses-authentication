        ...
        <>
            ...
            <div className="flex justify-around">
                ...
                <button onClick={() => handleSocialLogin(githubLogin)}
                    className='btn btn-secondary btn-sm btn-outline'>Github</button>
                <button onClick={() => handleSocialLogin(facebookLogin)}
                    className='btn btn-secondary btn-sm btn-outline'>Facebook</button>
            </div>
        </>
    );
};
